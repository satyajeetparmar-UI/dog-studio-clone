    ...
    <>
      <main>
        <div className="hover-images">
          ...
          <div className='bg-img' id='navy-pier'></div>
          <div className='bg-img' id='msi-chicago'></div>
          <div className='bg-img' id='phone'></div>
          <div className='bg-img' id='kikk'></div>
          <div className='bg-img' id='kennedy'></div>
          <div className='bg-img' id='opera'></div>
        </div>
        <Canvas id='canvas-main' style={{
          height: "100vh",
          width: "100vw",
          position: "fixed",
          top: 0,
        ...
        <section id='section-1'>
          <div className='navbar'>
            <svg className='logo' xmlns="http://www.w3.org/2000/svg" fill='white' viewBox="0 0 401.23099 116.838">
            ...
            <p> Our showreel</p>
            <div>
              <button type="button" className="site-header-button" title="Toggle menu">
                <span className="button-bar button-bar--1"></span>
                <span className="button-bar button-bar--2"></span>
                <span className="button-bar button-bar--3"></span>
              </button>
            </div>
          </div>
        ...
        <section id='section-2'>
          <div className="container">
            ...
            <ul>
              <li>
                <a img-title="tomorrowland" href="">
                  <span>2020 - Ongoing</span> Tomorrowland
                </a>
              </li>
              <li>
                <a img-title="navy-pier" href="">
                  <span>2018 - Today</span> Navy Pier
                </a>
              </li>
              <li>
                <a img-title="msi-chicago" href="">
                  <span>2015 - Today</span> MSI Chicago
                </a>
              </li>
              <li>
                <a img-title="phone" href="">
                  <span>2016</span> This Was Louise’s Phone
                </a>
              </li>
              <li>
                <a img-title="kikk" href="">
                  <span>2012 - Today</span> KIKK Festival 2018
                </a>
              </li>
              <li>
                <a img-title="kennedy" href="">
                  <span>2017</span> The Kennedy Center
                </a>
              </li>
              <li>
                <a img-title="opera" href="">
                  <span>2016 - Ongoing</span> Royal Opera Of Wallonia
                </a>
              </li>
            </ul>
        ...
        <section id='section-4'>
          <div className="container">
            <div className="middle">
              ...
              <div className="right">
                <p>
                  Dogstudio is a design & technology firm working globally from our offices based in Belgium and Chicago. Our strong focus on producing high quality & emotional branding, digital products and experiences became a signature.
                </p>
                <p>
                  We’re passionate about moving people and solving problems for the likes of Microsoft, The Museum of Science And Industry Of Chicago, The Kennedy Center of Washington, Dragon, Quanta Magazine, and many more.
                </p>
              </div>
            </div>  
          </div>
